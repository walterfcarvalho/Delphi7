...
begin
   ...
   result :=  dir +'logs\' + ExtractFilename(ParamStr(0))  + '_log.txt';
end;
...
begin
   ...
   if (s <> '') then
      ...
      gravaLog('Lendo registro, chave: ' + folder + ' Parametro: ' + Key + ' Resultado: ' + 'Não achei essa chave');
   RParReg:= s;
end;
...
begin
   ...
   gravaLog('Lendo parâmentro ini, seção:' + secao + ', chave: '+ param + ', Resultado: '+ res );

   if (res = '') then
     gravaLog('parâmetro não encontrado !!!! parâmentro ini, seção:' + secao + ', chave: '+ param + ', Resultado: '+ res );
