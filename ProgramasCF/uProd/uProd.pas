...
begin
  ...
  ean := msg.msgInput('Para cancelar apague o código.', ean);
...
begin
   ...
   begin
		codigo := msg.msgInput('Digite o Código do produto ou EAN.', codigo);
...
begin
	if (nmCpPesq = 'is_ref') then
		...
		ds:= 	uprod.getDadosProdBasico(fmMain.getUOCD(), cpPesq, '101', '0', 'esse campo não é usado');
