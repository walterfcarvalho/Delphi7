...
// pegando o registro inicial da impressora
   ...
   begin
      ...
      begin
         ...
         if (dif > 0) then
         begin
             f.gravalog('Diferença:' + floatToStrFomatado(dif, false) );
            ...
            begin
               ...
               f.gravaLog('Erro: ');
               f.gravaLog('Não achei o registro C481, C485 para o C405');
               f.gravaLog('');
         end;
      end
      else
