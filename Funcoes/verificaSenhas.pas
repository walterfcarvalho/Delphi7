...
uses
  ...
  DB, ADODB, TFlatButtonUnit, ConsultaSenha, uUsuarios, uDm ;
...
begin
   ...
   FmSenha.cbUsuarios.Items :=   uUsuarios.getUsuariosWell('', Grupos, usuarios);  //  FuncSQL.getUsuariosWell(Conexao,'13', '' );
   FmSenha.ShowModal;
